...
// Этот файл содержит дампы ПЗУ БИС К145ИК2П.
// Данная БИС применялись в советском калькуляторе "Электроника Б3-14" и других моделях.
...
// Первый диод в блоке кодирует младшую область команд, второй старшую.
...
MNEMONICS=[
    ...
    [ "LS=R[+0]+S",             "LS=R[+0]+S" ],
    [ "LS=R[+0]+S+L?1:0",       "LS=R[+0]+S+L?1:0" ],
    [ "R[-1]=S=M[+0]; M[+0]=S", "S<=>M[+0]" ],
    [ "S=R[+0]+S; R[+0]=0",     "S=R[+0]+S" ],
    [ "LS=R[+0]+1",             "LS=R[+0]+1" ],
    [ "R[+0]=R[-3]",            "" ],
    [ "R[-1]=S=R[+0]; R[+0]=S", "S=R[+0]" ],
    [ "S=R[+0]; R[+0]=R[-3]",   "S=R[+0]" ],
    [ "S=R[+0]",                "S=R[+0]" ],
    [ "L=0; S=6; R[+0]=S",      "L=0; S=6" ],
    [ "LS=~R[+0]+1",            "LS=~R[+0]+1" ],
    [ "S=~R[+0]",               "S=~R[+0]" ],
    [ "S=~S",                   "S=~S" ],
    [ "S=R[+0]+6",              "S=R[+0]+6" ],
    ...
    [ "R[-1]=R[+0]",            "" ],
    [ "R[-1]=0",                "" ],
    [ "LS=~R[+0]+L?1:0",        "LS=~R[+0]+L?1:0" ],
    [ "M[+0]=S",                "M[+0]=S" ],
    [ "L=R[+0]-L?0:1",          "L=R[+0]-L?0:1" ],
    [ "LS=S+T?0:1",             "LS=S+T?0:1" ]
]
