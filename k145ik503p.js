...
// Этот файл содержит дампы ПЗУ БИС К145ИК503П.
...
MNEMONICS_IK503P = [
    ...
    [ "LS=S+R[+0]", "LS=S+R[+0]" ],
    [ "R[-1]=S=R[+0];M[+0]=S", "S=R[+0];M[+0]=S" ],
    [ "LS=R[-1]=S-1", "LS=R[-1]=S-1" ],
    [ "LS=~S|R[+0]+1", "LS=~S|R[+0]+1" ],
    [ "S=R[+0]+6", "S=R[+0]+6" ],
    [ "R[-1]=S=R[+0]", "S=R[+0]" ],
    [ "LS=R[+0]+7", "LS=R[+0]+7" ],
    [ "LS=~S+M[+0]", "LS=~S+M[+0]" ]
...
COMMENTS_IK503P = [
    "Wait ring mark if M0.7==15 PC=0x40", // 00
    "", // 01
    "", // 02
    "", // 03
    "", // 04
    ...
    "", // 3E
    "", // 3F
    "Check ring code if M0.10==3 PC=0x60 else PC=0x00", // 40
    "", // 41
    "", // 42
    "", // 43
    "", // 44
